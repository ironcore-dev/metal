...
type ConstraintSpecApplyConfiguration struct {
	Path               *v1alpha1.JSONPath          `json:"path,omitempty"`
	Aggregate          *v1alpha1.AggregateType     `json:"agg,omitempty"`
	Equal              *v1alpha1.ConstraintValSpec `json:"eq,omitempty"`
	NotEqual           *v1alpha1.ConstraintValSpec `json:"neq,omitempty"`
...
func (b *ConstraintSpecApplyConfiguration) WithPath(value v1alpha1.JSONPath) *ConstraintSpecApplyConfiguration {
	b.Path = &value
	return b
}
...
func (b *ConstraintSpecApplyConfiguration) WithAggregate(value v1alpha1.AggregateType) *ConstraintSpecApplyConfiguration {
	b.Aggregate = &value
	return b
}
...
func (b *ConstraintSpecApplyConfiguration) WithEqual(value v1alpha1.ConstraintValSpec) *ConstraintSpecApplyConfiguration {
	b.Equal = &value
	return b
}
...
func (b *ConstraintSpecApplyConfiguration) WithNotEqual(value v1alpha1.ConstraintValSpec) *ConstraintSpecApplyConfiguration {
	b.NotEqual = &value
	return b
}
